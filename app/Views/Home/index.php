...
<?= $this->section('title') ?><?= 'Voluntia' ?><?= $this->endSection() ?>

<?= $this->section("content") ?>

    <div class="hero-wrap" style="background-image:url(images/xbg_4.jpg.pagespeed.ic.CGmtoox6Uo.webp)" data-stellar-background-ratio="0.5">
        <div class="overlay"></div>
        <div class="container">
            <div class="row no-gutters slider-text js-fullheight align-items-center justify-content-center" data-scrollax-parent="true">
                <div class="col-md-12 text ftco-animate mt-5 text-center" data-scrollax=" properties: { translateY: '70%' }">

                    <h1 class="mb-4" data-scrollax="properties: { translateY: '30%', opacity: 1.6 }">Give A Hand To Make The World Better</h1>
                </div>
            </div>
        </div>
    </div>
    <section class="ftco-section ftco-no-pt ftco-no-pb ftco-volunteer">
        <div class="container-fluid px-md-0">
            <div class="row no-gutters">
                <div class="col-md-6 img-volunteer" style="background-image:url(images/xabout.jpg.pagespeed.ic.iRY6Bo8isu.webp)">
    ...
    <section class="ftco-section ftco-vol img" style="background-image:url(images/xbg_3.jpg.pagespeed.ic.1rO7ABZu4E.webp)">
        <div class="overlay"></div>
        <div class="container">
            ...
            <div class="row">
                <div class="col-md-4">
                    <div class="causes causes-2 text-center ftco-animate">
                        <div class="img" style="background-image:url(images/xcauses-1.jpg.pagespeed.ic.RHGynvkmDQ.webp)"></div>
                ...
                <div class="col-md-4">
                    <div class="causes causes-2 text-center ftco-animate">
                        <div class="img" style="background-image:url(images/xcauses-2.jpg.pagespeed.ic.7wK6DQs35T.webp)"></div>
                ...
                <div class="col-md-4">
                    <div class="causes causes-2 text-center ftco-animate">
                        <div class="img" style="background-image:url(images/xcauses-3.jpg.pagespeed.ic.J9c7yWhAu-.webp)"></div>
    ...
    <section class="ftco-counter ftco-section img" id="section-counter" style="background-image:url(images/xbg_2.jpg.pagespeed.ic.8tHXQCxIUq.webp)">
        <div class="overlay"></div>
        <div class="container">
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="blog-entry align-self-stretch ftco-animate">
                        <a href="blog-single.html" class="block-20 img" style="background-image:url(images/ximage_1.jpg.pagespeed.ic.UizkzGlaqO.webp)">
                        </a>
                ...
                <div class="col-md-6">
                    <div class="blog-entry align-self-stretch d-md-flex bg-light p-3 align-items-center d-flex ftco-animate">
                        <a href="blog-single.html" class="block-20 thumb" style="background-image:url(images/ximage_2.jpg.pagespeed.ic.mpXQ8ps1u8.webp)">
                        </a>
                    ...
                    <div class="blog-entry align-self-stretch d-md-flex bg-light p-3 align-items-center d-flex ftco-animate">
                        <a href="blog-single.html" class="block-20 thumb" style="background-image:url(images/ximage_3.jpg.pagespeed.ic.THVjvfHlDT.webp)">
                        </a>
                        <div class="text text-thumb d-block pl-2 pl-md-4">
                    ...
                    <div class="blog-entry align-self-stretch d-md-flex bg-light p-3 align-items-center d-flex ftco-animate">
                        <a href="blog-single.html" class="block-20 thumb" style="background-image:url(images/ximage_4.jpg.pagespeed.ic.0Yz_jfrWrt.webp)">
                        </a>
                        <div class="text text-thumb d-block pl-2 pl-md-4">
        ...
        <div class="container">
            <div class="row ftco-animate justify-content-center">
                <div class="col-md-6 d-flex">
                    <div class="testimony-img" style="background-image:url(images/xtestimony-img.jpg.pagespeed.ic.4A2VVC0983.webp)"></div>
                </div>
                        ...
                        <div class="item">
                            <div class="testimony-wrap">
                                ...
                                <div class="d-flex align-items-center">
                                    <div class="user-img" style="background-image:url(images/xperson_1.jpg.pagespeed.ic.a2MnMHMs44.webp)">
                                    </div>
                                    <div class="pos ml-3">
